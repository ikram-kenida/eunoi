...
const Login = () => {
  ...
  return (
    ...
    <div className="w-100">
      <h1 className="mb-5 title-login text-center">Sign <span style={{color:'#8cccc9'}}>Up</span></h1>
...
<div className="form-group mt-5 mb-4 position-relative">
  ...
  >
    <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} />
        ...
        <button type="submit" className=" mt-5 btn btn-primary w-100">Sign Up</button>
        <div className="text-center mt-3">
  <span>Already have an account? </span>
  <a href="/signup" className="signup-link">Log in</a>
</div>
      </form>
    </div>
